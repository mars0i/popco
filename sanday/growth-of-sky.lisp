...
(defvar *run-fn-name* 'growth-of-sky-pop) ; change this for different script behavior
(defvar *run-fn* #'growth-of-sky-pop) ; change this for different script behavior
