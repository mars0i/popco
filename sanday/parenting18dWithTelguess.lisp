...
(setf *persons-reporting-to-guess* '(e03))
;(write-person-graphs "/Users/mabrams/docs/phil/software/cohere/graphs/sanday/parenting18/d/analogy/0/")
(telguess "/Users/mabrams/docs/phil/software/cohere/graphs/sanday/parenting18/d/analogy/0/" 'e03)
(sleep 5)
(start-reports-to-guess)

(unless (y-or-n-p "Continue?")
  (error "You don't want to continue!"))
