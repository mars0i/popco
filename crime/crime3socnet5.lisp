...
(make-no-bias-crime-talker 'aa crime-propns '(pundits folks) '(vulcans bajorans))  ; pundit

;; Vulcans who talk only to to Vulcans
(make-virus-bias-crime-talker 'template-v '() '(vulcans folks) '(vulcans))
...
(make-virus-bias-crime-talker 'template-vf '() '(vulcans federation folks) '(vulcans federation))
(n-persons-with-name 'template-vf 'vf *link-subset-size*)
(kill 'template-vf)

;; Bajorans who talk only to Bajorans
(make-beast-bias-crime-talker 'template-b '() '(bajorans folks) '(bajorans))
(n-persons-with-name 'template-b 'b (- *group-size* *link-subset-size*))
(kill 'template-b)

;; Bajorans who talk to friendly Vulcans
(make-virus-bias-crime-talker 'template-bf '() '(bajorans federation folks) '(bajorans federation))
