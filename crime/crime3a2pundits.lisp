;; crime3a2pundits.lisp
;; no bias for any person
...
(make-no-bias-crime-talker 'aaT crime-propns) ; "aaT" i.e. the true believer, who believes all the crime propns
(make-no-bias-crime-talker 'aaF crime-propns) ; "aaF" i.e. the the naysayer, who disbelieves all the crime propns
