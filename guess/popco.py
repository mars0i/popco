...
# Python ignorance--can't figure out how to do this inside the class
def toggleShowNeighbors():
	if toggleShowNeighbors.inOperation == 0:
		showNeighbors().do()
		toggleShowNeighbors.inOperation = 1
	else:
		showNeighbors().undo()
		toggleShowNeighbors.inOperation = 0
toggleShowNeighbors.inOperation = 0
...
def showPropnLabels():
	(concerns1 == "").labelvisible = 1  # the concerns1 field should always empty in proposition nodes

def hidePropnLabels():
	(concerns1 == "").labelvisible = 0 # see preceding fn
...
def showMapLabels():
	(concerns1 <> "").labelvisible = 1

def hideMapLabels():
	(concerns1 <> "").labelvisible = 0
...
def makePopcoMenu(): 
	...
	toggleShowNeighborsItem.actionPerformed = lambda event : toggleShowNeighbors()
...
def miscConfig():
        ...
        #setDisplayBackground("0,0,0") # set bg color
