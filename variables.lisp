...
(defvar *grossberg?* nil "Alternative activation function.") ; OBSOLETE in sepsettle and subsequent branches 11/15/2012
(defvar *testnum* 1)
(defvar *verbose* t)
...
(defvar *all-social-net-groups* (list *the-population*)) ; should store all social network groups (including e.g. small gentemp'ed groups)
