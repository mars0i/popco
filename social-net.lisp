...
;; PROPERTIES OF PERSONS USED HERE:
;;      groups:    Groups I am in. 
;;      talks-to:  Groups of people I talk to.
;;      num-listeners: max number of people I will talk to on any one tick.
;;
;; NOTE: Groups may include autogenerated groups containing only one or two persons.
;; This allows using groups to represent a (directed) graph representing
